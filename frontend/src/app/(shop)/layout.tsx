        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center">
              <span className="text-2xl font-bold text-purple-600">Masked 11</span>
            </Link>
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link href="/categories/clothing" className="text-gray-700 hover:text-purple-600 transition-colors">
                Clothing
              </Link>
              <Link href="/categories/shoes" className="text-gray-700 hover:text-purple-600 transition-colors">
                Shoes
              </Link>
              <Link href="/categories/accessories" className="text-gray-700 hover:text-purple-600 transition-colors">
                Accessories
              </Link>
              <Link href="/categories/bags" className="text-gray-700 hover:text-purple-600 transition-colors">
                Bags
              </Link>
            </nav>
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">Masked 11</h3>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Masked 11. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
